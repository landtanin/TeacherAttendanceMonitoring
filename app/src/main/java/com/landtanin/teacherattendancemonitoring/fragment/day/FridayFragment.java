...
import com.landtanin.teacherattendancemonitoring.databinding.FragmentFridayBinding;
...
public class FridayFragment extends Fragment {
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        RealmResults<LecturerModuleDao> lecturerModuleDao = realm.where(LecturerModuleDao.class).equalTo("day","Fri", Case.SENSITIVE).findAll();


        Log.w("FRIDAY_module", String.valueOf(lecturerModuleDao.size()));
        ...
        if (lecturerModuleDao.size()!=0) {
            ...
            TimeTableListAdapter.ClickListener clickListener = new TimeTableListAdapter.ClickListener() {
                ...
                public void myOnClickListener(String moduleId, int itemNumber) {
                    ...
                    RealmResults<LecturerModuleDao> forClickLecturerModuleDao = realm.where(LecturerModuleDao.class).equalTo("day","Fri", Case.SENSITIVE).findAll();
