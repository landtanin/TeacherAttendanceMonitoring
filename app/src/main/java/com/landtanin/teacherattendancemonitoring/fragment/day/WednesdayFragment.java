...
import com.landtanin.teacherattendancemonitoring.databinding.FragmentWednesdayBinding;
...
public class WednesdayFragment extends Fragment {
    ...
    private FragmentWednesdayBinding b;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b = DataBindingUtil.inflate(inflater, R.layout.fragment_wednesday, container, false);
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        RealmResults<LecturerModuleDao> lecturerModuleDao = realm.where(LecturerModuleDao.class).equalTo("day","Wed", Case.SENSITIVE).findAll();
        ...
        if (lecturerModuleDao.size()!=0) {
            ...
            TimeTableListAdapter.ClickListener clickListener = new TimeTableListAdapter.ClickListener() {
                ...
                public void myOnClickListener(String moduleId, int itemNumber) {
                    ...
                    RealmResults<LecturerModuleDao> forClickLecturerModuleDao = realm.where(LecturerModuleDao.class).equalTo("day","Wed", Case.SENSITIVE).findAll();
