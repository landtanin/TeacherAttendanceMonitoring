...
public class TodayModule {
    ...
    public RealmResults<LecturerModuleDao> getTodayModule() {

        String weekDay = dayOfWeek();

        Realm realm = Realm.getDefaultInstance();
        RealmResults<LecturerModuleDao> studentModuleDao = realm.getDefaultInstance()
                .where(LecturerModuleDao.class)
